            ...
            <ul className="w-full grid  justify-items-stretch">
                {listAthletes.map((athlete) => (
                    <li className="border-4 border-light-blue-500 border-opacity-100  flex items-center justify-between gap-2 mb-3" key={athlete.id}>
                        ...
                        <div> 
                            {isIMC && <input placeholder="Peso (kg)" key={athlete.id} className="w-20 h-8 bg-gray-100 rounded-md border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>}
